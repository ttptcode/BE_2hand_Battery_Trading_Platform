    ...
    public class ConversationsController : ControllerBase
    {
            ...
            [FromQuery] Guid buyerId)
        {
            try
            {
                ...
                {
                    return BadRequest(ApiResponse<ConversationResponseDto>.ErrorResult("Invalid input", "Listing ID cannot be empty"));
                }
                
                if (buyerId == Guid.Empty)
                {
                    return BadRequest(ApiResponse<ConversationResponseDto>.ErrorResult("Invalid input", "Buyer ID cannot be empty"));
                }
            ...
            {
                return BadRequest(ApiResponse<ConversationResponseDto>.ErrorResult("Invalid input", ex.Message));
            }
            catch (Exception ex)
            {
